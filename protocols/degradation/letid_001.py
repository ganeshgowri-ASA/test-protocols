"""
Light and Elevated Temperature Induced Degradation Protocol Implementation
...
class LETID001Protocol(BaseProtocol):
    ...
    Test LeTID effects in silicon modules
    """

    def __init__(self):
        super().__init__(protocol_id="LETID-001")
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            for equipment in ['Environmental Chamber', 'Light Source', 'IV Curve Tracer']:
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            self.add_measurement("LETID-001_data", measurement_data)
