"""
Performance at Different Irradiances Protocol Implementation
...
class PERF002Protocol(BaseProtocol):
    ...
    Measure performance across irradiance range (100-1200 W/m²)
    """

    def __init__(self):
        super().__init__(protocol_id="PERF-002")
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            self.add_measurement("PERF-002_data", measurement_data)
    ...
    def generate_report(self) -> dict:
        ...
        try:
            ...
            report = {
                ...
                'protocol_name': 'Performance at Different Irradiances',
