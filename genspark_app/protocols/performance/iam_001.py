"""
Incidence Angle Modifier Protocol Implementation
...
class IAM001Protocol(BaseProtocol):
    ...
    Measure angular response characteristics
    """

    def __init__(self):
        super().__init__(protocol_id="IAM-001")
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            for equipment in ['Solar Simulator', 'Rotation Stage', 'IV Curve Tracer']:
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            self.add_measurement("IAM-001_data", measurement_data)
    ...
    def generate_report(self) -> dict:
        ...
        try:
            ...
            report = {
                ...
                'protocol_name': 'Incidence Angle Modifier',
