"""
Temperature Coefficients Protocol Implementation
...
class TEMP001Protocol(BaseProtocol):
    ...
    Determine temperature coefficients (alpha, beta, gamma)
    """

    def __init__(self):
        super().__init__(protocol_id="TEMP-001")
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            for equipment in ['Solar Simulator', 'Environmental Chamber', 'IV Curve Tracer']:
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            self.add_measurement("TEMP-001_data", measurement_data)
    ...
    def generate_report(self) -> dict:
        ...
        try:
            ...
            report = {
                ...
                'protocol_name': 'Temperature Coefficients',
