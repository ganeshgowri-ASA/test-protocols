"""
EVA Yellowing Protocol Implementation
...
class YELLOW001Protocol(BaseProtocol):
    ...
    Test EVA encapsulant yellowing
    """

    def __init__(self):
        super().__init__(protocol_id="YELLOW-001")
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            for equipment in ['UV Chamber', 'Spectrophotometer']:
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            self.add_measurement("YELLOW-001_data", measurement_data)
