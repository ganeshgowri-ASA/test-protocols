"""
Performance at Different Temperatures Protocol Implementation
...
class PERF001Protocol(BaseProtocol):
    ...
    Measure performance across temperature range (15°C to 75°C)
    """

    def __init__(self):
        super().__init__(protocol_id="PERF-001")
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            self.add_measurement("PERF-001_data", measurement_data)
