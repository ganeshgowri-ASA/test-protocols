...
class NOCT001Protocol(BaseProtocol):
    ...
    Determine module temperature under nominal operating conditions
    """

    def __init__(self):
        super().__init__(protocol_id="NOCT-001")
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            for equipment in ['Solar Simulator', 'Environmental Chamber', 'Temperature Sensors']:
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            self.add_measurement("NOCT-001_data", measurement_data)
