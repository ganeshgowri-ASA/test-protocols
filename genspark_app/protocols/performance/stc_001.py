"""
Standard Test Conditions Testing Protocol Implementation
...
class STC001Protocol(BaseProtocol):
    """
    Standard Test Conditions Testing

    Measure PV module performance under standard test conditions (1000 W/m², 25°C, AM1.5G)
    """

    def __init__(self):
        super().__init__(protocol_id="STC-001")
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            for equipment in ['Solar Simulator', 'IV Curve Tracer', 'Temperature Sensor', 'Irradiance Sensor']:
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            self.add_measurement("STC-001_data", measurement_data)
    ...
    def generate_report(self) -> dict:
        ...
        try:
            ...
            report = {
                ...
                'protocol_name': 'Standard Test Conditions Testing',
