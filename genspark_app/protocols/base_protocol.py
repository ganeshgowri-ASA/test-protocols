...
class BaseProtocol(ABC):
    ...
    def load_template(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self._log_audit("template_loaded", {"template_path": str(self.template_path)})
    ...
    def set_test_conditions(self, conditions: Dict[str, Any]):
        """Set test conditions"""
        old_conditions = self.test_conditions.copy()
        self.test_conditions = conditions
        logger.info(f"Set test conditions for {self.protocol_id}: {conditions}")
        self._log_audit("conditions_set", {
            "old_values": old_conditions,
            "new_values": conditions
        })
    ...
    def add_equipment(self, equipment_id: str, equipment_type: str):
        ...
        self._log_audit("equipment_added", {
            "equipment_id": equipment_id,
            "equipment_type": equipment_type
        })
    ...
    def update_progress(self, percentage: int, step: ProtocolStep, message: str = ""):
        ...
        self._log_audit("progress_updated", {
    ...
    def add_error(self, error_message: str):
        ...
        self._log_audit("error_occurred", {"message": error_message})
    ...
    def add_warning(self, warning_message: str):
        ...
        self._log_audit("warning_occurred", {"message": warning_message})
    ...
    def run(self) -> bool:
        ...
        try:
            ...
            self._log_audit("protocol_started", {"start_time": self.start_time.isoformat()})
            ...
            self._log_audit("protocol_completed", {
            ...
            self._log_audit("protocol_failed", {"error": str(e)})
            return False
    ...
    def pause(self):
        ...
        if self.status == ProtocolStatus.RUNNING:
            ...
            self._log_audit("protocol_paused", {})
    ...
    def resume(self):
        ...
        if self.status == ProtocolStatus.PAUSED:
            ...
            self._log_audit("protocol_resumed", {})
    ...
    def cancel(self):
        ...
        self._log_audit("protocol_cancelled", {})
